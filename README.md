...
- Implement object-oriented architecture with scalable internal structures (AVL Tree, Linked Lists)
...
| Data Structs | AVL Tree, Linked List  |
---
...
- Add or remove songs
- Each playlist is stored by a unique ID, not just its name

### Playlist Playback
- In-browser audio player
- Play, pause, skip, go back
- Shuffle support using a randomized copy of linked list
...
Created by Justin Bruinsma  
Built with purpose, structure, and my love for music.
